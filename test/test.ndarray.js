...
tape( 'the function has an arity of 7', function test( t ) {
	t.strictEqual( gcuevery.length, 7, 'has expected arity' );
	t.end();
});
...
tape( 'the function returns a reference to the output array', function test( t ) {
	...
	out = gcuevery( x.length, x, 1, 0, y, 1, 0 );
...
tape( 'if provided an `N` parameter less than or equal to `0`, the function returns the output array unchanged', function test( t ) {
	...
	out = gcuevery( 0, x, 1, 0, y, 1, 0 );
	t.deepEqual( out, expected, 'returns expected value' );

	out = gcuevery( -4, x, 1, 0, y, 1, 0 );
	t.deepEqual( out, expected, 'returns expected value' );
...
tape( 'if provided an `N` parameter less than or equal to `0`, the function returns the output array unchanged (accessors)', function test( t ) {
	...
	gcuevery( 0, toAccessorArray( x ), 1, 0, toAccessorArray( y ), 1, 0 );
	t.deepEqual( y, expected, 'returns expected value' );

	gcuevery( -4, toAccessorArray( x ), 1, 0, toAccessorArray( y ), 1, 0 );
	t.deepEqual( y, expected, 'returns expected value' );
...
tape( 'the function cumulatively tests whether every element is truthy', function test( t ) {
	...
	gcuevery( x.length, x, 1, 0, out, 1, 0 );
	t.deepEqual( out, expected, 'returns expected value' );
...
tape( 'the function cumulatively tests whether every element is truthy (accessors)', function test( t ) {
	...
	gcuevery( x.length, toAccessorArray( x ), 1, 0, toAccessorArray( out ), 1, 0 );
	t.deepEqual( out, expected, 'returns expected value' );
...
tape( 'the function supports an `x` stride (accessors)', function test( t ) {
	...
	gcuevery( 4, toAccessorArray( x ), 2, 0, toAccessorArray( out ), 1, 0 );
	t.deepEqual( out, expected, 'returns expected value' );
...
tape( 'the function supports an `out` stride (accessors)', function test( t ) {
	...
	gcuevery( 4, toAccessorArray( x ), 1, 0, toAccessorArray( out ), 2, 0 );
	t.deepEqual( out, expected, 'returns expected value' );
...
tape( 'the function supports a negative `x` stride (accessors)', function test( t ) {
	...
	gcuevery( 4, toAccessorArray( x ), -1, 3, toAccessorArray( out ), 1, 0 );
	t.deepEqual( out, expected, 'returns expected value' );
...
tape( 'the function supports a negative `out` stride (accessors)', function test( t ) {
	...
	gcuevery( 4, toAccessorArray( x ), 1, 0, toAccessorArray( out ), -1, 3 );
	t.deepEqual( out, expected, 'returns expected value' );
...
tape( 'the function supports an `x` offset (accessors)', function test( t ) {
	...
	gcuevery( 3, toAccessorArray( x ), 1, 2, toAccessorArray( out ), 1, 0 );
	t.deepEqual( out, expected, 'returns expected value' );
...
tape( 'the function supports an `out` offset (accessors)', function test( t ) {
	...
	gcuevery( 3, toAccessorArray( x ), 1, 0, toAccessorArray( out ), 1, 2 );
	t.deepEqual( out, expected, 'returns expected value' );
...
tape( 'the function supports complex access patterns (accessors)', function test( t ) {
	...
	gcuevery( 3, toAccessorArray( x ), 2, 1, toAccessorArray( out ), -2, 5 );
	t.deepEqual( out, expected, 'returns expected value' );
